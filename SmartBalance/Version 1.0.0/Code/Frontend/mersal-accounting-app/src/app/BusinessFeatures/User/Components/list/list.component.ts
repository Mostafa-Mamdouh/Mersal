...
export class ListComponent implements OnInit {
    ...
    dataStateChange(state: DataStateChangeEvent): void {
        ...
        if (this.filter.length > 0) {
            for (var _i = 0; _i < this.filter.length; _i++) {
                ...
                if (this.filter[_i].field == "userName") {
                    this.postSearch.userName = this.filter[_i].value;
                }
                ...
                if (this.filter[_i].field == "birthDate") {
                    this.postSearch.birthDateFrom = this.filter[_i].value.toISOString().substring(0, 10);
                    this.postSearch.birthDateTo = new Date(Date.now()).toISOString().substring(0, 10);
                }
                ...
                if (this.filter[_i].field == "maxPaymentLimit") {
                    this.postSearch.maxPaymentLimitTo = this.filter[_i].value;
                }
            }
    ...
    getList() {
        ...
        //debugger
        this.userService.getUsersByPost(this.postSearch)
            .subscribe(res => {
                debugger;
