...
@Component({
  selector: 'cost-center-type-list',
...
export class ListComponent implements OnInit {
  ...
  public pageChange(event: PageChangeEvent): void {
    ...
    let url = [`/cost-center-type/list/${this.pageIndex}`];
  ...
  getList() {
    ...
    //debugger
    this.costCenterTypeService.getCostCenterTypesByPost(this.postSearch)
      .subscribe(res => {
