...
export class CurrencyService extends BaseService {
  ...
  private controller: string = `${this.backendServerUrl.baseApiUrl}Currencys`;
  ...
  getCurrency(id: any): Observable<Currency> {
    let url: string = `${this.controller}/get/${id}`;
    return this.getData<Currency>(url);
  }
  addCurrency(item: Currency): Observable<Currency> {
