...
import { DiscountPercentLight } from '../../Models/discount-percent.model';
...
export class ListComponent implements OnInit {
  ...
  public pageChange(event: PageChangeEvent): void {
    ...
    let url = [`/expenses-type/list/${this.pageIndex}`];
  ...
  getList() {
    ...
    //debugger
    this.discountPercentService.getDiscountPercentByPost(this.postSearch)
      .subscribe(res => {
