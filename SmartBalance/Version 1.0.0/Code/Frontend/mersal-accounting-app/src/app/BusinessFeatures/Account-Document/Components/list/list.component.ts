...
import { AccountDocumentService } from '../../../Account-Document/Services/account-document.service';
...
export class ListComponent implements OnInit {
  ...
  accountCharts: any[] = [];// BranchLookup[] = [];
  journalTypes: any[] = [];
  list: any[] = [];
  ...
  public pageChange(event: PageChangeEvent): void {
    ...
    let url = [`/account-document/list/${this.pageIndex}`];
  ...
  getList() {
    ...
    debugger
    this.accountDocumentService.getAccountDocumentsByPost(this.postSearch)
      .subscribe(res => {
