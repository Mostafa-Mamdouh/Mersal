...
import { FixedAssetExcludedReportSearch } from '../../Models/report-filter.model';
...
@Component({
  selector: 'app-fixed-asset-excluded-report',
  templateUrl: './fixed-asset-excluded-report.component.html',
  styleUrls: ['./fixed-asset-excluded-report.component.css']
})
export class FixedAssetExcludedReportComponent implements OnInit {

  searchForm: FormGroup;
  searchModel: FixedAssetExcludedReportSearch;
  ...
  gotoReport(): void {
    if (this.searchForm.valid) {
      ...
      let url: string = `${rootUrl}Reports/FixedAssetsExcludedReport/?dateFrom=${dateFrom}&dateTo=${dateTo}&lang=${lang}`;
