...
import { BankReportSearch } from '../../Models/report-filter.model';
...
@Component({
  selector: 'app-fixed-asset-move-report',
  templateUrl: './fixed-asset-move-report.component.html',
  styleUrls: ['./fixed-asset-move-report.component.css']
})
export class FixedAssetMoveReportComponent implements OnInit {

  searchForm: FormGroup;
  searchModel: BankReportSearch;
  ...
  gotoReport(): void {
    if (this.searchForm.valid) {
      ...
      // let url: string = `${rootUrl}Reports/BankAccountReport/?bankId=${bankId}&dateFrom=${dateFrom}&dateTo=${dateTo}&lang=${lang}`;
