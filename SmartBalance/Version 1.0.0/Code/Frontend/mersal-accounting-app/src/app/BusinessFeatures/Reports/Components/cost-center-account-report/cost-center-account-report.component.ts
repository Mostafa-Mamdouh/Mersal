...
@Component({
  selector: 'app-cost-center-account-report',
  templateUrl: './cost-center-account-report.component.html',
  styleUrls: ['./cost-center-account-report.component.css']
})
export class CostCenterAccountReportComponent implements OnInit {
  ...
  gotoReport(): void {
    if (this.searchForm.valid) {
      ...
      let url: string = `${rootUrl}Reports/CostCenterAccountReport/?costCenterId=${costCenterId}&dateFrom=${dateFrom}&dateTo=${dateTo}&lang=${lang}`;
