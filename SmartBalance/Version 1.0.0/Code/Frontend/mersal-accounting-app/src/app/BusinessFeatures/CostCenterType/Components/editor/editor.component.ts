...
import { CostCenterType } from '../../Models/cost-center-type.model';
import { NotificationService } from '../../../../SharedFeatures/SharedMain/Services/notification.service';
import { FinancialService } from '../../../Financial/Services/financial.service';
import { CostCenterTypeService } from '../../Services/cost-center-type.service';
...
@Component({
  selector: 'cost-center-type-editor',
...
export class EditorComponent implements OnInit {
  ...
  extractRouteParams(): void {
    ...
    if (this.id) {
      this.costCenterTypeService.getCostCenterType(this.id)
        .subscribe(res => {
          debugger;
          this.itemModel = res;
    ...
    if (this.canEdit()) {
      ...
      if (this.editorForm.valid) {
        if (this.editorMode == EditorMode.add) {
          ...
          this.costCenterTypeService.addCostCenterType(this.itemModel)
            .subscribe(res => {
              ...
              () => {
                console.log(`addCostCenterType completed.`);
              });
        }
        else if (this.editorMode == EditorMode.edit) {
          this.collectModelFromForm();
          this.costCenterTypeService.updateCostCenterType(this.itemModel)
            .subscribe(res => {
              this.notificationService.showOperationSuccessed();
              this.gotoList();
            },
              ...
              () => {
                console.log(`updateCostCenterType completed.`);
              });
        }
      }
      else {
  ...
  private itemModel: CostCenterType = new CostCenterType();
  maxDate: Date;
  minDate: Date;
