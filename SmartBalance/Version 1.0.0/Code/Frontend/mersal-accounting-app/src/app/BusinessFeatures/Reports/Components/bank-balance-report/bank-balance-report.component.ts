...
@Component({
  selector: 'app-bank-balance-report',
  templateUrl: './bank-balance-report.component.html',
  styleUrls: ['./bank-balance-report.component.css']
})
export class BankBalanceReportComponent implements OnInit {
  ...
  gotoReport(): void {
    if (this.searchForm.valid) {
      ...
      let url: string = `${rootUrl}Reports/BankBalanceReport/?bankId=${bankId}&dateFrom=${dateFrom}&dateTo=${dateTo}&lang=${lang}`;
