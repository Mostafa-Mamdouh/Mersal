...
@Component({
  selector: 'app-vendor-balance-report',
  templateUrl: './vendor-balance-report.component.html',
  styleUrls: ['./vendor-balance-report.component.css']
})
export class VendorBalanceReportComponent implements OnInit {
  ...
  gotoReport(): void {
    if (this.searchForm.valid) {
      ...
      let url: string = `${rootUrl}Reports/VendorBalanceReport/?vendorId=${vendorId}&dateFrom=${dateFrom}&dateTo=${dateTo}&lang=${lang}`;
