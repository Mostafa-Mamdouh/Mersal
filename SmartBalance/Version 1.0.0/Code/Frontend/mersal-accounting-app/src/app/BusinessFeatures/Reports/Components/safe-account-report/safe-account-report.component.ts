...
@Component({
  selector: 'app-safe-account-report',
  templateUrl: './safe-account-report.component.html',
  styleUrls: ['./safe-account-report.component.css']
})
export class SafeAccountReportComponent implements OnInit {
  ...
  gotoReport(): void {
    ...
    let url: string = `${rootUrl}Reports/SafeAccountReport/?safeId=${safeId}&dateFrom=${dateFrom}&dateTo=${dateTo}&lang=${lang}`;
