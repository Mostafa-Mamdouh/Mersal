...
import { FixedAssetLocationReportSearch } from '../../Models/report-filter.model';
...
@Component({
  selector: 'app-fixed-asset-location-report',
  templateUrl: './fixed-asset-location-report.component.html',
  styleUrls: ['./fixed-asset-location-report.component.css']
})
export class FixedAssetLocationReportComponent implements OnInit {

  searchForm: FormGroup;
  searchModel: FixedAssetLocationReportSearch;
  ...
  gotoReport(): void {
    if (this.searchForm.valid) {
      ...
      let url: string = `${rootUrl}Reports/FixedAssetsLocationReport/?locationId=${locationId}&dateFrom=${dateFrom}&dateTo=${dateTo}&lang=${lang}`;
