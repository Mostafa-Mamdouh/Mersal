...
@Component({
  selector: 'app-bank-account-report',
  templateUrl: './bank-account-report.component.html',
  styleUrls: ['./bank-account-report.component.css']
})
export class BankAccountReportComponent implements OnInit {
