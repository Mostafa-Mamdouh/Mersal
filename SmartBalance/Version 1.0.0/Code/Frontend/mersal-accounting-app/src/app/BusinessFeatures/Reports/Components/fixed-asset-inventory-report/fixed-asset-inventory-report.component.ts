...
import { FixedAssetInventoryReportSearch } from '../../Models/report-filter.model';
...
@Component({
  selector: 'app-fixed-asset-inventory-report',
  templateUrl: './fixed-asset-inventory-report.component.html',
  styleUrls: ['./fixed-asset-inventory-report.component.css']
})
export class FixedAssetInventoryReportComponent implements OnInit {

  searchForm: FormGroup;
  searchModel: FixedAssetInventoryReportSearch;
  ...
  gotoReport(): void {
    if (this.searchForm.valid) {
       ...
       let url: string = `${rootUrl}Reports/FixedAssetsInventoryReport/?locationId=${locationId}&dateFrom=${dateFrom}&dateTo=${dateTo}&lang=${lang}`;
