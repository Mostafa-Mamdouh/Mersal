...
namespace MersalAccountingService.Core.IServices
{
    ...
    public interface IGroupsService : IBaseService
    {
		...
		/// <param name="model"></param>
		/// <returns></returns>
		GenericCollectionViewModel<ListGroupsLightViewModel> GetByFilter(GroupFilterViewModel model);

		IList<GroupLightViewModel> GetAllUnSelectedGroupsForUser(long userId);

		GroupPermissionListViewModel GetGroupPermission(long groupId);
		GroupPermissionListViewModel UpdateGroupPermission(GroupPermissionListViewModel model);


		GroupRoleListViewModel GetGroupRole(long groupId);
		GroupRoleListViewModel UpdateGroupRole(GroupRoleListViewModel model);
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        GroupViewModel Add(GroupViewModel model);
