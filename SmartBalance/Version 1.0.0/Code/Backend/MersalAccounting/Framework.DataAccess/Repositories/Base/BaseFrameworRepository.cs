...
namespace Framework.DataAccess.Repositories.Base
{
	...
	public class BaseFrameworRepository<TEntity, TEntityIdentity> : IBaseFrameworRepository<TEntity, TEntityIdentity>
		where TEntity : class, IEntityIdentity<TEntityIdentity>
	{
		...
		/// type BaseFrameworRepository.
		/// </summary>
		/// <param name="context"></param>
		public BaseFrameworRepository(DbContext context)
		{
