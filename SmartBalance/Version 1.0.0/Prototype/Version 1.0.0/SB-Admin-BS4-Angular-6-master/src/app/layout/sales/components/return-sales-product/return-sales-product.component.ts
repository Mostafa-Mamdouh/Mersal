...
import { ReturnSalesProductService } from '../../services/return-sales-product.service';

@Component({
  selector: 'app-return-sales-product',
  templateUrl: './return-sales-product.component.html',
  styleUrls: ['./return-sales-product.component.scss'],
  animations: [routerTransition()],
  providers: [ReturnSalesProductService]
})
export class ReturnProductComponent implements OnInit {
  ...
  constructor(private translate: TranslateService, public router: Router, private fb: FormBuilder,
    private salesServ: ReturnSalesProductService) {
